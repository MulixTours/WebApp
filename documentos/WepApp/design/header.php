                ...
                <ul class="slides">
                    <li> <img src="http://lorempixel.com/580/250/nature/1">
                        ...
                        <div class="caption center-align">
                            ...
                            <h5 class="light grey-text text-lighten-3">Here's our small slogan.</h5> </div>
                    </li>
...
<!--Inicia contenedor, este lo escondi en este archivo y termina en el
archivo Footer, para evitar quitarlo. -->
<div class="container">